    ...
    <div  x-show="!open" class="hover:shadow p-6 bg-white border-blue-500 border-t-2">
        <div class="flex items-center ">
            <button type="button" @click="open = ! open"
                    class="px-4 py-2 bg-blue-500 text-white font-semibold rounded hover:bg-blue-600">Show Create Todo Form
            </button>
        </div>
    </div>
            ...
            <form>
                <div class="mb-6">
                    <label for="title"
                        ...
                        Todo </label>
                    <input type="text" wire:model="content" wire:keydown.enter="addTodo" id="title" placeholder="Add Todo.."
